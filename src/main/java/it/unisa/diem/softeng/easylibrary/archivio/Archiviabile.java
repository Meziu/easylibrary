 ...
 *
 * È generalmente richiesto lista di elementi e gli elementi al suo interno
 * siano modificati solo tramite l'uso di modifica().
 *
...
public interface Archiviabile<E> extends Serializable {
     ...
     * @post L'elemento è presente nella lista restituita da getLista() ed è
     * disponibile per modifiche tramite modifica().
     *
     ...
     *
     * Segna come rimosso un elemento dall'archivio. Non è richiesto che
     * l'elemento sia strutturalemente rimosso dalla collezione. La rimozione
     * può trattarsi anche solo di una segnalazione sull'elemento.
     *
     ...
     *
     * @post La lista di elementi filtrati contiene solo elementi per cui è
     * asserito il metodo Filtro.controlla() di `f`.
     */
