...
/**
 * @brief Rappresenta la matricola di un utente della biblioteca. Ogni \ref
 * Utente è associato univocamente ad una matricola. Le matricole sono composte
 * da esattamente 10 cifre numeriche.
 *
 * @see Utente
 */
public final class Matricola implements Comparable<Matricola>, Serializable {
    ...
    /**
     * @brief Costruttore. Costruisce un nuovo oggetto Matricola a partire dalla
     * stringa di caratteri che la compongono, verificandone la validità.
     *
     * @param\[in] matricola Stringa di caratteri della matricola.
     *
     * @throws MatricolaInvalidaException Se la matricola non aderisce allo
    ...
    /**
     * @brief Verifica della matricola. Verifica se la stringa passata come
     * argomento sia o meno una matricola valida. Una matricola è valida se è
     * composta esattamente da 10 cifre numeriche
     *
    ...
    /**
     * @brief Comparazione con un'altra Matricola. La comparazione è svolta
     * aderendo al contratto di Comparable, dove una Matricola è ordinata
     * rispetto ad un'altra in ordine lessicografico della stringa di caratteri
     * associata.
     *
     * @param\[in] matricola da confrontare
     * @return Valore negativo, zero o positivo se questa matricola è
     * rispettivamente minore, uguale o maggiore rispetto alla matricola
     * passata.
     */
    @Override
    ...
    /**
     * @brief HashCode associato alla Matricola. Il calcolo è svolto aderendo al
     ...
     * Object.equals(), dove una Matricola è considerata uguale ad un'altra solo
     * se la stringa di caratteri associata è uguale.
     *
