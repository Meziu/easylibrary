...
\begin{xltabular}[h]{\textwidth}{
        | >{\rule{0pt}{34pt}\hsize=.4\hsize\centering\arraybackslash}X
    ...
    \multirow{3}{*}{\hyperlink{IF}{Funzionalità Individuali}} &
	    ...
	    \requisiteline{IF-1.4}{Ricerca di un utente}{Alta} &
	    ...
	    \requisiteline{IF-2.4}{Ricerca di un libro}{Alta}
    \hline
	...
	\multirow{3}{*}{\hyperlink{RNF}{Requisiti Non Funzionali}} &
		\requisiteline{RNF-1.1}{Usabilità della piattaforma}{Alta} &
