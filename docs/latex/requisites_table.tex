...
\begin{xltabular}[h]{\textwidth}{
    ...
    \multirow{3}{*}{\hyperlink{IF}{Funzionalità Individuali}} &
	    \requisiteline{IF-1.1}{Registrazione di un nuovo utente nel sistema}{Alta} &
	    \requisiteline{IF-1.2}{Modifica dei dati di un utente nel sistema}{Alta} &
	    \requisiteline{IF-1.3}{Rimozione di un utente dal sistema}{Alta} &
	    \requisiteline{IF-1.4}{Ricerca di un utente nel sistema}{Alta} &
	    \requisiteline{IF-2.1}{Inserimento di un nuovo libro nella biblioteca}{Alta} &
	    \requisiteline{IF-2.2}{Modifica dei dati relativi ad un libro nella biblioteca}{Alta} &
	    \requisiteline{IF-2.3}{Rimozione di un libro dalla biblioteca}{Alta} &
	    \requisiteline{IF-2.4}{Ricerca di un libro nella biblioteca}{Alta}
    \hline
	...
	\multirow{3}{*}{\hyperlink{UI}{Interfaccia Utente}} &
	    ...
	    \requisiteline{UI-3.2}{Visualizzazione per la registrazione di un nuovo libro}{Media} &
	...
	\multirow{3}{*}{\hyperlink{RNF}{Requisiti Non Funzionali}} &
		\requisiteline{RNF-1.1}{Interfaccia Utente Grafica via JavaFX}{Alta} &
		\requisiteline{RNF-1.2}{Usabilità della piattaforma}{Alta} &
		\requisiteline{RNF-2.1}{Affidabilità della piattaforma}{Alta} &
		\requisiteline{RNF-2.2}{Sicurezza dei dati}{Media} &
		\requisiteline{RNF-2.3}{Scalabilità delle informazioni}{Bassa}
	\hline
\end{xltabular}
