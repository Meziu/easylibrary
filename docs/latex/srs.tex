...
\newpage
\usecase{UC-\stepcounter{ucid}}{Eliminazione di un libro dal catalogo}{Gestore della biblioteca}{Il gestore sta visualizzando l'elenco dei libri.}{Il libro viene rimosso.}{
	\vspace{-0.8\topsep}
	\begin{enumerate}
