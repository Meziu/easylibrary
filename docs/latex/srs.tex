...
Il sistema permette un interazione per mostrare la vista dello storico completo dei prestiti (per requisito 4.3). Se la schermata viene chiusa con conferma della modifica da apportare, i dati relativi al nuovo \\prestito saranno registrati nell’archivio.}{Alta}
...
\usecase{UC-\stepcounter{ucid}}{Visualizzazione del catalogo dei libri}{Gestore della biblioteca.}{Il gestore può interagire con la Menu-Bar.}{Il gestore ha consultato il catalogo dei libri.}{
	\vspace{-0.8\topsep}
	\begin{enumerate}
...
\usecase{UC-\stepcounter{ucid}}{Visualizzazione dei prestiti attivi}{Gestore della biblioteca}{Il gestore può interagire con la Menu-Bar.}{Le informazioni relative ai prestiti attivi vengono mostrate, evidenziando i prestiti in ritardo, in un elenco ordinato per data prevista di restituzione.}{
	\vspace{-0.8\topsep}
	\begin{enumerate}
...
\usecase{UC-\stepcounter{ucid}}{Visualizzazione dell’elenco degli utenti}{Gestore della biblioteca}{Il gestore può interagire con la Menu-Bar.}{Viene mostrato l’elenco degli utenti ordinato alfabeticamente per\\cognome e, a parità di cognome, per nome.}{
	\vspace{-0.8\topsep}
	\begin{enumerate}
