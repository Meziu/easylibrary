...
\usecase{UC-\stepcounter{ucid}}{Visualizzazione dello storico completo dei prestiti}{Gestore della biblioteca}{Il gestore sta visualizzando la sezione relativa ai prestiti attivi.}{Le informazioni relative a tutti i prestiti vengono mostrate, evidenziando i prestiti in ritardo, in un elenco ordinato per data prevista di restituzione.}{
	\vspace{-0.8\topsep}
	\begin{enumerate}
